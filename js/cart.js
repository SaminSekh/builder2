...
const Cart = (() => {
    ...
    function render() {
        ...
        // HTML escape helper for cart rendering
        ...
        drawer.innerHTML = `
            ...
            <div class="sf-cart-body">
                ...
                ${items.map((item, i) => `
                    <div class="sf-cart-item">
                        <img src="${esc(item.img)}" class="sf-cart-item-img" onerror="this.src='https://placehold.co/100x100?text=Product'"/>
                        <div class="sf-cart-item-info">
                            <div>
                                <span class="sf-cart-item-name">${esc(item.name)}</span>
                                <span class="sf-cart-item-price">${esc(item.price)}</span>
                            </div>
            ...
            <div class="sf-cart-footer">
                ...
                <div class="sf-cart-total-row">
                    <span>Subtotal</span>
                    <span>${esc(config.currency)}${subtotal.toLocaleString()}</span>
                </div>
                <div class="sf-cart-total-row">
                    <span>Shipping</span>
